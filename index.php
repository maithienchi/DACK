    ...
    <h4 class="card-title">
      <div class="row">
        <div class="col-sm-0">
          ...
          <img src ="avatar.php?id=<?php echo $posts['userId']; ?>" class="img-circle" alt="Cinque Terre" width="35" height="35">
          <!-- <img style="width: 150px;" src ="avatar.php?id=<?php echo $posts['userId']; ?>"> -->
